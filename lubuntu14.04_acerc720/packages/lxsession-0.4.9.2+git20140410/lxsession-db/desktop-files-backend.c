/* desktop-files-backend.c generated by valac 0.22.1, the Vala compiler
...
static void _lxsession_db_default_apps_on_finish_scanning_installed_lxsession_db_default_apps_finish_scanning_installed (LxsessionDBDefaultApps* _sender, gpointer self) {
	lxsession_db_default_apps_on_finish_scanning_installed (self);
}


static void _lxsession_db_default_apps_on_finish_scanning_available_lxsession_db_default_apps_finish_scanning_available (LxsessionDBDefaultApps* _sender, gpointer self) {
	lxsession_db_default_apps_on_finish_scanning_available (self);
}
...
gchar* lxsession_db_default_apps_create_entry (LxsessionDBDefaultApps* self, GKeyFile* kf, const gchar* desktop_path) {
	...
	}
	{
		...
		gchar* _tmp9_ = NULL;
		_tmp8_ = kf;
		_tmp9_ = g_key_file_get_value (_tmp8_, "Desktop Entry", "Icon", &_inner_error_);
		_tmp7_ = _tmp9_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == G_KEY_FILE_ERROR) {
	...
	}
	{
		...
		gchar* _tmp12_ = NULL;
		_tmp11_ = kf;
		_tmp12_ = g_key_file_get_value (_tmp11_, "Desktop Entry", "X-AppInstall-Package", &_inner_error_);
		_tmp10_ = _tmp12_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == G_KEY_FILE_ERROR) {
	...
	_tmp15_ = _tmp14_;
	_tmp16_ = kf;
	_tmp17_ = lxsession_db_default_apps_create_exec_string (self, _tmp16_);
	_tmp18_ = _tmp17_;
...
gchar* lxsession_db_default_apps_create_exec_string (LxsessionDBDefaultApps* self, GKeyFile* kf) {
	...
	tmp_value = _tmp6_;
	tmp_value_length1 = _vala_array_length (_tmp5_);
